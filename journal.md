...
1. Scarlett Perez
2. Michael Vlamis
3. Marjorie Dudemaine
4. Mars Lapierre-Furtado
5. Tatiana Désormeaux (me)
...
+ Perhaps there would be keywords that could be clicked.
+ There could maybe be an exploration element to it almost like a game.
+ We thought about aesthetics of the website and how all the video footage we currently have has an old film effect and a soft edge, so we could theme our website around that aesthetic.
+ There could be elements of side scrolling.
+ Possibly Layering.
+ Maybe webcam usage
+ We were told that we had a lot of creative artistic liberties we could take, so now it would be up to discussing with VK what they are desiring.
+ Having a typical home page with a header that has the four seasons as clickable buttons that sends the user to the page for each season.
+ The home page would also have a title and a short description of the project and the goals.
...
### Wish List
+ Fully done website on a website development platform with a host and all.
...
+ If this would be expanded or standalone.
...
## Our Brainstorm Map
![](<Images/CART 470 - Brainstorm.JPEG>)
